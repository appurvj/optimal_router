  ...
  google.maps.event.addDomListener(window, 'load', initialize);
    ...
    mapObj.controls[google.maps.ControlPosition.TOP_RIGHT].push(scrollControlDiv);		
...
function ScrollControl(controlDiv, map) {
  ...
  controlUI.className = "btn btn-warning btn-small"
	controlDiv.appendChild(controlUI);
	

  // Set CSS for the control interior
  var controlText = document.createElement('div');
  controlText.innerHTML = '<b>Enable Scroll</b>';
  ...
  // Setup the click event listeners
    ...
    controlText.innerHTML = scrollWheel?"Disable Scroll":"Enable Scroll";
  });
